package com.luis.curso.springboot.app.interceptor.springbootinterceptor.interceptor;
...
/*
        ...
        String jsonString = mapper.writeValueAsString(json);//convierte el dato a tipo json
